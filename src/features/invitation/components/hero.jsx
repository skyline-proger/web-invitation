...
export default function Hero() {
  ...
  return (
    <section
      id="hero"
      className="min-h-screen min-h-[100dvh] flex flex-col items-center justify-center px-4 py-16 sm:py-20 text-center relative overflow-hidden bg-transparent"
    >
      {/* 
        The background <img> or <div> is removed from here. 
        It is now handled by body::before in index.css 
      */}
